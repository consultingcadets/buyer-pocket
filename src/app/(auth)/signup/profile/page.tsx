          ...
          <form action={formAction} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                name="agency_name"
                type="text"
                className="w-full min-h-12 px-4 bg-white border border-border rounded-lg focus:outline-none focus:border-2 focus:border-accent transition-colors text-[16px] text-text-primary"
              />
